...
// <--------------------- This section is for a GET Api --------------------->
 ...
 useEffect(() => {
   ...
   // <--------------------- The  GET Api   section end here --------------------->

   // <--------------------- This section is for a PUT AND POST API --------------------->
    ...
    const handleEdit = (item) => {
     ...
     // <--------------------- The PUT AND POST API  section end here --------------------->

    // <--------------------- This section is for a DELETE Api --------------------->
    //DeleteAPI
  ...
  // <--------------------- The DELETE API section end here --------------------->

    return(
        <>
        <h1 className="main-heading">CRUD OPERATION ON EMPLOYEES API</h1>
